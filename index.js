 ...
 * Versión Libre de SQLite / Base de Datos
 */
...
// ==========================================
// 3. CARGADOR MODULAR DE COMANDOS
// ==========================================
...
client.once('ready', () => {
    console.log(`\n========================================`);
    console.log(`🛡️ SN SECURITY v6.0 (NO SQLITE EDITION)`);
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.isButton()) {
        ...
        if (id.startsWith('appeal_')) {
            ...
            // Obtener roles asignados desde memoria
